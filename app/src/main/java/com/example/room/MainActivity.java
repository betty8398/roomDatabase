...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btModify.setOnClickListener((v) -> {
            new Thread(() -> {
                ...
                DataBase.getInstance(this).getDataDao().updateData(data);
                runOnUiThread(() -> {
                    edName.setText("");
                    edPhone.setText("");
                    edHobby.setText("");
        ...
        btCreate.setOnClickListener((v -> {
            new Thread(() -> {
                ...
                DataBase.getInstance(this).getDataDao().insertData(data);
                runOnUiThread(() -> {
                    myAdapter.refreshView();
                    edName.setText("");
                    edPhone.setText("");
        ...
        /**初始化RecyclerView*/
        new Thread(() -> {
            List<MyData> data = DataBase.getInstance(this).getDataDao().displayAll();
    ...
    private static class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public void refreshView() {
            new Thread(() -> {
                List<MyData> data = DataBase.getInstance(activity).getDataDao().displayAll();
                this.myData = data;
